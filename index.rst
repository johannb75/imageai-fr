...
Une fois que vous avez installŽ tous ces packages sur votre ordinateur, vous pouvez installer **ImageAI** en utilisant la commande pip ci-dessous.
Installation de **ImageAI** ::

    pip3 install https://github.com/OlafenwaMoses/ImageAI/releases/download/2.0.2/imageai-2.0.2-py3-none-any.whl


Une fois que **ImageAI** est installŽ, vous pouvez en quelques lignes de code accomplir les t‰ches de vision assistŽe par ordinateur les plus puissantes comme vous pouvez le voir ci-dessous.  
**Reconnaissance dÕImage**
